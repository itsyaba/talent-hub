...
export const passwordResetTemplate = (url: string) => {
  const content = `
        ...
        <p>We received a request to reset your password for your account. For your security, no changes have been made to your account yet.</p>
...
export const magicLinkTemplate = (url: string) => {
  const content = `
        ...
        <p>Welcome back! Use the secure link below to sign in to your Service account. For your security, this link will only be valid for the next 10 minutes.</p>
